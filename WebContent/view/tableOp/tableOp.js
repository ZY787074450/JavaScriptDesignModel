...
var setings = {
		...
		queryArea:{
			...
			queryCondition:[//查询条件配置，显示顺序，按照你的配置顺序显示
			        //组件1
			        {
			        ...
			        //组件3
			        {
			        	type:"select",//下拉选择框
			        	id:"key2",//id属性
			        	keyName:"key",//规定后台的JSON数据对象中的key的名字,你要保存的值,默认值:key
			        	valueName:"value",//规定后台的JSON数据对象中的value的名字，前台显示给用户的值,默认值:value
			        	data:[{"key":"cn","value":"中国"},{"key":"us","value":"美国"}],//标准的数据JSON对象，是keyName与valueName的组成的key=value形式的JSON对象
			        	callback:{
                            click:function(){  //配置点击事件
			...
			queryButton:[//查询按钮配置
				{
					type:"button", //查询按钮的类型 [button,reset,image]【按钮，重置功能按钮，图片按钮】
					value:"查询",//配置按钮的显示文字
					id:"key3",//id属性
					callback:{
                        click:function(){  //配置点击事件
				...
				{
					type:"image", //查询按钮的类型 [button,reset,image]【按钮，重置功能按钮，图片按钮】
				...
				{
					type:"reset", //查询按钮的类型 [button,reset,image]【按钮，重置功能按钮，图片按钮】
					value:"重置",//重置按钮显示的文字类型
					id:"key3",//id属性
					callback:{
                        click:function(){ //配置点击事件
		...
		fnArea:{
			fn:[//功能数组
			    ...
			    },
			    {
			    	type:"button",//功能的类型[button,image]【按钮，图片】
			    	value:"新增",//按钮显示的文字
			    	id:"key3",//id属性，如果kind是add,该id是弹出框的id
			    	kind:"add",//[add,export,print] 【新增，导出，打印】
					callback:{
                        click:function(){ //配置点击事件
